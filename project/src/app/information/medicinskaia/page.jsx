...
export const metadata = {
  title: "Медицинская перекись водорода | Информация о продукции",
  description:
    "Статьи о медицинской перекиси водорода. Производство и применение в различных отраслях.",
};

const headData = {
  headTitle: "Медицинская перекись водорода",
  headDescription: "Подробная информация о медицинской перекиси водорода, областях применения и процессах изготовления"
};
