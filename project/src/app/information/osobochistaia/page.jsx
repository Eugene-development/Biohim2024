...
export const metadata = {
  title: "Особочистая перекись водорода (ОСЧ) | Информация о продукции",
  description:
    "Статьи об особочистой перекиси водорода (ОСЧ). Производство и применение в различных отраслях.",
};
