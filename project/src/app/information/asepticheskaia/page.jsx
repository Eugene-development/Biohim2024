...
export const metadata = {
  title: "Асептическая перекись водорода | Информация о продукции",
  description:
    "Статьи о асептической перекиси водорода. Производство и применение в различных отраслях.",
};

const headData = {
  headTitle: "Асептическая перекись водорода",
  headDescription: "Подробная информация о асептической перекиси водорода, областях применения и процессах изготовления"
};
