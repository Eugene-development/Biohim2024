...
export default () => {
  return (
    <div className="isolate overflow-hidden bg-gray-900">
      <div className=" max-w-7xl px-6 pb-96 pt-24 sm:pt-32 lg:px-20">
        <div className=" max-w-4xl">
          <h2 className="text-base font-semibold leading-7 text-indigo-400">
            Мы лучшие в своём деле
          </h2>
          <p className="mt-2 text-4xl font-bold tracking-tight text-white sm:text-7xl">
            Наши направления
          </p>
        </div>
      ...
      {/* <div className="mx-auto max-w-7xl px-6 pb-96 pt-24 text-center sm:pt-32 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <h2 className="text-base font-semibold leading-7 text-indigo-400">Мы лучшие в своём деле</h2>
